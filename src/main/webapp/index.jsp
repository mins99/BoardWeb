	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li class="active"><a href="main.jsp"><spring:message code="message.user.header.main"/></a></li>
				<c:if test="${userID ne null }">
				<li><a href="/getBoardList.do"><spring:message code="message.user.header.board"/></a></li>
				</c:if>
			</ul>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="login.do?lang=ko"><spring:message code="message.user.header.login"/></a></li>
			...
			<c:if test="${userID ne null }">
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="logoutAction.jsp"><spring:message code="message.user.header.logout"/></a></li>
						</ul>
					</li>
				</ul>
			</c:if>
